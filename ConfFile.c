/* ConfFile.c generated by valac 0.34.4, the Vala compiler
...
gchar** mathg_conf_file_tryread (mathgConfFile *self, int* result_length1) {
	...
	GError * _inner_error_ = NULL;
	{
		...
		data_stream = _tmp3_;
		_tmp5_ = data_stream;
		_tmp7_ = g_data_input_stream_read_line_utf8 (_tmp5_, &_tmp6_, NULL, &_inner_error_);
		st = _tmp6_;
		_tmp4_ = _tmp7_;
		if (G_UNLIKELY (_inner_error_ != NULL)) {
	...
	__catch2_g_error:
	{
		...
		fprintf (_tmp14_, "%s\n", _tmp16_);
		_tmp18_ = mathg_conf_file_trywrite (&(*self), "10 1 10 +/ 2 20 .01", &_tmp17_);
		_tmp19_ = _tmp18_;
