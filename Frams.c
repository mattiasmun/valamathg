/* Frams.c generated by valac 0.34.4, the Vala compiler
...
void _vala_main (gchar** args, int args_length1) {
	...
	_tmp9_ = (_tmp0_ != NULL) ? _vala_array_dup2 (_tmp0_, _tmp0__length1) : ((gpointer) _tmp0_);
	_tmp9__length1 = _tmp0__length1;
	data = _tmp9_;
	data_length1 = _tmp9__length1;
	_data_size_ = data_length1;
	gtk_init (&args_length1, &args);
	_tmp10_ = (GtkWindow*) gtk_window_new (GTK_WINDOW_TOPLEVEL);
...
void frame (GtkWindow* gw, gchar** args, int args_length1) {
	...
	_tmp1_ = gw;
	gtk_window_move (_tmp1_, 0, 200);
	_tmp2_ = gw;
	g_signal_connect ((GtkWidget*) _tmp2_, "destroy", (GCallback) _gtk_main_quit_gtk_widget_destroy, NULL);
	_tmp3_ = args;
	_tmp3__length1 = args_length1;
	_tmp4_ = mathg_event_cog_new (_tmp3_, _tmp3__length1);
	g_object_ref_sink (_tmp4_);
	ec = _tmp4_;
	_tmp5_ = gw;
	gtk_container_add ((GtkContainer*) _tmp5_, (GtkWidget*) ec);
	_tmp6_ = gw;
