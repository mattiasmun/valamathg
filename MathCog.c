/* MathCog.c generated by valac 0.20.1, the Vala compiler
...
void mathg_math_cog_init (mathgMathCog *self, gchar** args, int args_length1) {
	...
	_tmp6_ = _tmp5_[1];
	_tmp7_ = mathg_number_utils_tl (&(*self).nu, _tmp6_);
	_tmp8_ = args;
	_tmp8__length1 = args_length1;
	_tmp9_ = _tmp8_[2];
	_tmp10_ = mathg_number_utils_tl (&(*self).nu, _tmp9_);
	_tmp11_ = args;
	...
	_tmp14_ = _tmp13_[4];
	_tmp15_ = mathg_number_utils_ti (&(*self).nu, _tmp14_);
	mathg_operate_destroy (&(*self).operation);
	mathg_operate_init (&(*self).operation, _tmp4_, _tmp7_, _tmp10_, _tmp12_, _tmp15_);
	_tmp17_ = args;
	_tmp17__length1 = args_length1;
	_tmp18_ = _tmp17_[5];
	_tmp19_ = mathg_number_utils_ti (&(*self).nu, _tmp18_);
	if (_tmp19_ > 1) {
		gchar** _tmp20_;
