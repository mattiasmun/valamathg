...
static void mathg_math_cog_close (mathgMathCog *self);
...
static void mathg_math_cog_close (mathgMathCog *self) {
	...
	_tmp1_ = (*self).straind;
	_tmp2_ = _tmp0_[_tmp1_];
	_tmp3_ = _tmp2_.answer;
	ans = _tmp3_;
	_tmp4_ = (*self).stra;
	_tmp4__length1 = (*self).stra_length1;
	_tmp5_ = (*self).straind;
	...
	_tmp9_ = hyp;
	_tmp10_ = ans;
	_tmp11_ = llabs (_tmp9_ - _tmp10_);
	d = (guint64) _tmp11_;
	_tmp12_ = (*self).cor;
	_tmp13_ = ans;
	_tmp14_ = llabs (_tmp13_);
	(*self).cor = _tmp12_ + _tmp14_;
	_tmp15_ = (*self).err;
	_tmp16_ = d;
	(*self).err = _tmp15_ + _tmp16_;
	_tmp17_ = (*self).stra;
	_tmp17__length1 = (*self).stra_length1;
	_tmp18_ = (*self).straind;
	_tmp19_ = ans;
	_tmp20_ = mathg_number_utils_ts (&(*self).nu, _tmp19_);
	_tmp21_ = _tmp20_;
	_tmp22_ = string_to_string (_tmp21_);
	_tmp23_ = d;
	_tmp24_ = mathg_number_utils_uts (&(*self).nu, _tmp23_);
	_tmp25_ = _tmp24_;
	_tmp26_ = string_to_string (_tmp25_);
	_tmp27_ = g_strconcat (" ans=", _tmp22_, " Δ=", _tmp26_, " t=", NULL);
	_g_free0 (_tmp17_[_tmp18_].result);
	_tmp17_[_tmp18_].result = _tmp27_;
	_g_free0 (_tmp25_);
	_g_free0 (_tmp21_);
	_tmp28_ = (*self).stra;
	...
	_tmp32_ = _tmp30_[_tmp31_].result;
	_tmp33_ = mathg_my_timer_to_string (&(*self).problem);
	_tmp34_ = _tmp33_;
	_tmp35_ = g_strconcat (_tmp34_, "ms", NULL);
	_tmp36_ = _tmp35_;
	_tmp37_ = g_strconcat (_tmp32_, _tmp36_, NULL);
	_g_free0 (_tmp30_[_tmp31_].result);
	_tmp30_[_tmp31_].result = _tmp37_;
	_g_free0 (_tmp36_);
	_g_free0 (_tmp34_);
	_tmp38_ = g_strdup ("tot Δ‰=");
	_g_free0 ((*self).res);
	(*self).res = _tmp38_;
	_tmp39_ = (*self).res;
	_tmp40_ = (*self).err;
	_tmp41_ = (*self).cor;
	_tmp42_ = (*self).pm;
	_tmp43_ = mathg_number_utils_uts (&(*self).nu, (guint64) ((((gdouble) _tmp40_) / _tmp41_) * _tmp42_));
	_tmp44_ = _tmp43_;
	...
	_tmp46_ = (*self).res;
	_tmp47_ = (*self).err;
	_tmp48_ = mathg_number_utils_uts (&(*self).nu, _tmp47_);
	_tmp49_ = _tmp48_;
	_tmp50_ = string_to_string (_tmp49_);
	_tmp51_ = mathg_my_timer_to_string (&(*self).total);
	_tmp52_ = _tmp51_;
	_tmp53_ = g_strconcat (" Δ=", _tmp50_, " t=", _tmp52_, "ms", NULL);
	_tmp54_ = _tmp53_;
	_tmp55_ = g_strconcat (_tmp46_, _tmp54_, NULL);
	_g_free0 ((*self).res);
	(*self).res = _tmp55_;
	_g_free0 (_tmp54_);
	_g_free0 (_tmp52_);
	_g_free0 (_tmp49_);
	_tmp57_ = (*self).straind;
	_tmp58_ = (*self).stra;
	_tmp58__length1 = (*self).stra_length1;
	if (_tmp57_ < (_tmp58__length1 - 1)) {
		_tmp56_ = 1;
	} else {
		_tmp56_ = 0;
	}
	_tmp59_ = (*self).straind;
	_tmp60_ = _tmp56_;
	(*self).straind = _tmp59_ + _tmp60_;
}
...
void mathg_math_cog_put (mathgMathCog *self) {
	...
	_tmp34_ = _tmp33_.guess;
	_tmp35_ = mathg_number_utils_td (&(*self).nu, _tmp34_);
	_tmp36_ = (*self).stra;
	_tmp36__length1 = (*self).stra_length1;
	_tmp37_ = (*self).straind;
	_tmp38_ = _tmp36_[_tmp37_];
	_tmp39_ = _tmp38_.answer;
	_tmp40_ = fabs ((_tmp35_ / _tmp39_) - 1);
	_tmp41_ = (*self).deviation;
	if (_tmp40_ <= _tmp41_) {
		_tmp30_ = TRUE;
	} else {
		gboolean _tmp42_;
		_tmp42_ = (*self).isenter;
		_tmp30_ = _tmp42_;
	}
	_tmp43_ = _tmp30_;
	if (_tmp43_) {
		mathg_math_cog_close (&(*self));
	}
	(*self).isenter = FALSE;
	_g_free0 (s);
}
